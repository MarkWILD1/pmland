/**
 * Institutions section orb — thinking-orbs preset "connecting".
 * Docs: https://orbs.jakubantalik.com/
 */
import { MODE_DRAWS, resolvePreset } from 'https://esm.sh/thinking-orbs@0.2.0';

const mount = document.getElementById('institutions-thinking-orb');
if (mount) {
  const displaySize = () => {
  ...
  canvas.setAttribute('aria-label', 'Presencia de Plan Maestro en todo el país');
